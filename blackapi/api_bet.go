...
type ApiDeleteBetSlipRequest struct {
	ctx _context.Context
	ApiService *BetApiService
	betslipId string
}
...
func (r ApiDeleteBetSlipRequest) Execute() (DeleteBetSlipResponse, *_nethttp.Response, error) {
	return r.ApiService.DeleteBetSlipExecute(r)
}

/*
 * DeleteBetSlip Method for DeleteBetSlip
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param betslipId
 * @return ApiDeleteBetSlipRequest
 */
func (a *BetApiService) DeleteBetSlip(ctx _context.Context, betslipId string) ApiDeleteBetSlipRequest {
	return ApiDeleteBetSlipRequest{
		ApiService: a,
		ctx: ctx,
		betslipId: betslipId,
...
/*
 * Execute executes the request
 * @return DeleteBetSlipResponse
 */
func (a *BetApiService) DeleteBetSlipExecute(r ApiDeleteBetSlipRequest) (DeleteBetSlipResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DeleteBetSlipResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BetApiService.DeleteBetSlip")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/betslips/{betslip_id}/"
